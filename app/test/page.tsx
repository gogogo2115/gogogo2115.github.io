...
export default function TestPage() {
  return (
    <>
      ...
      <div>{process.env.NEXT_PUBLIC_CONFIG_PACKAGE_NAME}</div>
      <div>{process.env.NEXT_PUBLIC_CONFIG_PACKAGE_VERSION}</div>
      <div>{process.env.NEXT_PUBLIC_CONFIG_NEXT_VERSION}</div>
    </>
  );
}
