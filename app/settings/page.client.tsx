...
const SettingsClientComponent = () => {
  ...
  return (
    <>
      ...
      <div role="radiogroup">
        <button type="button" className="cursor-pointer" role="radio" aria-checked={settings.fontSize === 1} data-value={1} onClick={handleFontSizeClick}>
          1
        </button>
        <button type="button" className="cursor-pointer" role="radio" aria-checked={settings.fontSize === 2} data-value={2} onClick={handleFontSizeClick}>
          2
        </button>
        <button type="button" className="cursor-pointer" role="radio" aria-checked={settings.fontSize === 3} data-value={3} onClick={handleFontSizeClick}>
          3
        </button>
        <button type="button" className="cursor-pointer" role="radio" aria-checked={settings.fontSize === 4} data-value={4} onClick={handleFontSizeClick}>
          4
        </button>
        <button type="button" className="cursor-pointer" role="radio" aria-checked={settings.fontSize === 5} data-value={5} onClick={handleFontSizeClick}>
          5
        </button>
      </div>
    </>
