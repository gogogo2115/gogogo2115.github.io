const STRICT_TRUE_BOOLEANS = new Set([true, 1, "true", "1"]);
const STRICT_FALSE_BOOLEANS = new Set([false, 0, "false", "0"]);
 ...
 * `strict` 옵션에 따라 엄격한 또는 느슨한 기준을 사용합니다. 기본값은 엄격한 기준입니다.
 *
 * @param value 확인할 값
 * @param strict 엄격한 기준을 사용할지 여부 (기본값: true)
 ...
 */
export const toBooleanStrict = (value: unknown, fallbackValue?: boolean | undefined | null): boolean | null | undefined => {
 ...
 * @returns 변환된 불리언 값 또는 fallbackValue
 */
export const toBooleanLoose = (value: unknown, fallbackValue?: boolean | undefined | null): boolean | null | undefined => {
